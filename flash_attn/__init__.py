...
from flash_attn_triton.flash_attn_interface import (
    ...
    flash_attn_kvpacked_func as flash_attn_varlen_kvpacked_func,
)

# Add additional aliases for backward compatibility
# Flash Attention 1.x renamed functions in FA2
from flash_attn_triton.flash_attn_interface import (
    flash_attn_func as flash_attn_unpadded_func,
    flash_attn_qkvpacked_func as flash_attn_unpadded_qkvpacked_func,
    flash_attn_kvpacked_func as flash_attn_unpadded_kvpacked_func,
)
